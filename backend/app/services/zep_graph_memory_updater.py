...
logger = get_logger('deepak.zep_graph_memory_updater')
...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Does not add simulation prefix to avoid misleading graph updates
        """
        ...
        # Return "agent name: activity description" format, no simulation prefix
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform and sends batches to Zep after accumulating BATCH_SIZE activities.
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        - LIKE_POST/DISLIKE_POST (like/dislike posts)
        - REPOST (repost)
        - FOLLOW (follow)
        - MUTE (mute)
        - LIKE_COMMENT/DISLIKE_COMMENT (like/dislike comments)
        
        action_args contains complete context information (such as post content, usernames, etc.).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval, avoid sending requests too fast
