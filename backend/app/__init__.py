"""
D.E.E.P.A.K. Backend - Flask application factory
"""
...
def create_app(config_class=Config):
    ...
    if should_log_startup:
        logger.info("=" * 50)
        logger.info("D.E.E.P.A.K. Backend starting...")
        logger.info("=" * 50)
    ...
    @app.before_request
    def log_request():
        logger = get_logger('deepak.request')
    ...
    @app.route('/health')
    def health():
        return {'status': 'ok', 'service': 'D.E.E.P.A.K. Backend'}

    if should_log_startup:
        logger.info("D.E.E.P.A.K. Backend startup complete")
