...
def fetch_new_actions_from_db(
    ...
    try:
        ...
        for rowid, user_id, action, info_json in cursor.fetchall():
            ...
            # Simplify action_args, keeping only key fields (full content preserved, not truncated)
            simplified_args = {}
...
async def run_twitter_simulation(
    ...
    # Twitter uses the primary LLM configuration
...
async def run_reddit_simulation(
    ...
    # Reddit uses boost LLM configuration (if available, otherwise falls back to primary config)
